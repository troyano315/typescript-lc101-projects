...
console.log(`it will take ${spaceShuttle.name} ${getDaysToLocation(kilometersToMars)}days to get to Mars`);
console.log(`it will take ${spaceShuttle.name} ${getDaysToLocation(kilometersToTheMoon)} days to get to Mars`);
